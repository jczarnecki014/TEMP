    ...
    return (
        <Fragment>
            ...
            <Row className='d-flex justify-content-center pt-1'>
                <Col sm='12' md="10">
                    <Form>
                        <LabelInput id="UserNameInput" label="Nazwa użytkownika" type="text" placeholder="Wpisz twoją nazwę użytkownika" className='mb-3' />
                        <LabelInput 
                            id="EmailInput" 
                            label="Adres email" 
                            inputType="email" 
                            ...
                            className='mb-3'
                        />
                        <LabelInput id="PasswordInput" label="Hasło" inputType="password" placeholder="Wpisz twoje hasło" className='mb-3' />
                        <LabelInput id="RePasswordInput" label="Powtórz hasło" type="password" placeholder="Wpisz hasło ponownie" className='mb-3' />
